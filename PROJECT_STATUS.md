...
| `20260603_match_participants_unique.sql`                    | **PR #24 리뷰 #3** — `match_participants(match_id, user_id)` UNIQUE 제약 추가(기존 PK id 단독이라 중복 참가자 DB 방어선 부재). 멱등 DO 블록, 적용 전 중복 0건 확인. **DB 적용 대기**                                                                                                                                                                                                                                                                                                                                                                                |
